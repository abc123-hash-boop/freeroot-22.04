...
if [ ! -e $ROOTFS_DIR/.installed ]; then
  ...
  wget --tries=$max_retries --timeout=$timeout --no-hsts -O $ROOTFS_DIR/usr/local/bin/proot "https://github.com/abc123-hash-boop/freeroot-22.04/raw/refs/heads/main/proot-${ARCH}"
